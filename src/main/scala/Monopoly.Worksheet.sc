...
val defaultBoard: Board = Board(Vector(
  GoField,
  PropertyField("Mediterranean Avenue", price = 60, rent = 2, color = Green, mortgage = Mortgage(price = 10, active = false)),
  PropertyField("Baltic Avenue", price = 60, rent = 4, color = Brown, mortgage = Mortgage(price = 10, active = false)),
  JailField,
