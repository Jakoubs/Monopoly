  ...
  def defineGame(): MonopolyGame = {
    ...
    val board = Board(
      Vector(
        ...
        TaxField(100, 5),
        TrainStationField("Marklylebone Station", 6,200, Some(playerVector.head)),
        PropertyField("lightBlue1", 7, 100, 6, Some(playerVector.head), color = PropertyField.Color.LightBlue, PropertyField.Mortgage(50, false), PropertyField.House(0)),
        ChanceField(8),
        PropertyField("lightBlue2", 9, 100, 6, Some(playerVector.head), color = PropertyField.Color.LightBlue, PropertyField.Mortgage(50, false), PropertyField.House(0)),
        PropertyField("lightBlue3", 10, 120, 8, Some(playerVector.head), color = PropertyField.Color.LightBlue, PropertyField.Mortgage(60, false), PropertyField.House(0)),
        JailField,
        PropertyField("Pink1", 12, 140, 10, Some(playerVector.head), color = PropertyField.Color.Pink, PropertyField.Mortgage(70, false), PropertyField.House(0)),
        UtilityField("Electric Company", 13,150,UtilityField.UtilityCheck.utility, Some(playerVector.head)),
        PropertyField("Pink2", 14, 140, 10, Some(playerVector.head), color = PropertyField.Color.Pink, PropertyField.Mortgage(70, false), PropertyField.House(0)),
        PropertyField("Pink3", 15, 160, 12, Some(playerVector.head), color = PropertyField.Color.Pink, PropertyField.Mortgage(80, false), PropertyField.House(0)),
        TrainStationField("Fenchurch ST Station", 16,200, Some(playerVector.head)),
