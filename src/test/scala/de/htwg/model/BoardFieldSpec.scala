...
class BoardFieldSpec extends AnyWordSpec {
  "PropertyField" should {
    "build a property field" in{
      val f1 = new PropertyField("kpAlee",10,100,20,Some("p1"),"red",1000,Some(0))
    ...
    "buildHomes" in{
      val f1 = new PropertyField("kpAlee",4, 100, 20, Some("P1"), "red", 1000, Some(0))
    ...
    "calculate house price based on rent correctly" in {
      ...
      val f2 = new PropertyField("Park Place",5, 350, 35, Some("P2"), "blue", 1750, Some(0))
      f2.calculateHousePrice(f2.rent) should be(180)

      val f3 = new PropertyField("Baltic Avenue",5, 60, 4, Some("P3"), "brown", 300, Some(0))
